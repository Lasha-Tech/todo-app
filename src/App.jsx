  ...
  return (
    <div className='App' style={{backgroundColor: day?'#FFF':'#171823'}}>
      <div className="header">
        ...
        <div className="backgroundImgColor" style={{background: day? 'linear-gradient(to left, #5596FF, #AC2DEB)'
      ...
      <div className="wrapper">
        ...
        {/* Input Container  */}
        <div className="input-container" style={{backgroundColor: day? '#FFF':'#25273D', boxShadow: day? '0px 35px 50px -15px rgba(194, 195, 214, 0.50)'
